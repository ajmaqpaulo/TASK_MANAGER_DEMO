...
export default function Login() {
  ...
  return (
    <div className="size-full flex items-center justify-center relative overflow-hidden" style={{ backgroundColor: '#14151A' }}>
      {/* Efectos de fondo glassmorphism - más sutiles */}
      ...
      <div className="w-full max-w-md mx-4 relative">
        {/* Logo - Posicionado encima del contenedor */}
        ...
        <div className="px-8 pt-16 pb-10 backdrop-blur-xl" style={{
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div>
              <label 
                ...
                style={{ color: '#9D833E', opacity: 0.8 }}
              >
                Correo
              </label>
              <input
                ...
                className="w-full px-0 py-2 transition-all duration-300 focus:outline-none placeholder:text-gray-600"
                style={{
                ...
                onFocus={(e) => {
                  ...
                  e.target.style.borderBottomColor = '#9D833E';
                }}
                onBlur={(e) => {
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '0 6px 24px 0 rgba(157, 131, 62, 0.6), inset 0 1px 0 0 rgba(255, 255, 255, 0.2)';
              }}
              onMouseLeave={(e) => {
          ...
          <div className="mt-6">
            <div className="relative flex items-center justify-center mb-5">
              ...
              <span 
                className="absolute px-4 text-xs backdrop-blur-md" 
                style={{ 
                  background: 'rgba(28, 29, 36, 0.6)', 
                  color: '#DEDEE0', 
                  opacity: 0.5 
            ...
            <button
              ...
              className="w-full py-3.5 transition-all duration-300 active:scale-[0.98] flex items-center justify-center gap-3 backdrop-blur-md group"
              style={{
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(42, 43, 49, 0.6)';
                e.currentTarget.style.borderColor = 'rgba(222, 222, 224, 0.15)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = 'rgba(42, 43, 49, 0.4)';
                e.currentTarget.style.borderColor = 'rgba(222, 222, 224, 0.08)';
              }}
            >
